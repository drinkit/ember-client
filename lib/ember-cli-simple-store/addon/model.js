...
let Model = EmberObject.extend({
    ...
    _setup() {
        ...
        attributes.forEach((attrName) => {
            defineProperty(model, attrName + "IsDirty", computed("_dirty", "_defaults", "" + attrName, function() {
            ...
            defineProperty(model, dynamicPrimedKey, computed("_primed", "" + attrName, function() {
                let primed = this.get("_primed");
